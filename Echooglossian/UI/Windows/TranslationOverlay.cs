...
namespace Echooglossian.UI.Windows
{
    internal class TranslationOverlay : IDisposable
    {
        ...
        public void Draw()
        {
            ...
            if (talkOverlayVisible && Service.configuration.TalkModuleEnabled && Service.configuration.TALK_UseImGui)
                DrawTalkOverlay();

            if (battleTalkOverlayVisible && Service.configuration.BattleTalkModuleEnabled && Service.configuration.BATTLETALK_UseImGui)
                DrawBattleTalkOverlay();

            if (talkSubtitleOverlayVisible && Service.configuration.TalkSubtitleModuleEnabled && Service.configuration.SUBTITLE_UseImGui)
                DrawTalkSubtitleOverlay();

            if (Service.configuration.ToastModuleEnabled && Service.configuration.TOAST_UseImGui)
            {
        ...
        public void UpdateTalkOverlay(string originalName, string originalText, string translatedName, string translatedText)
        {
            ...
            bool showTitle = Service.configuration.TALK_TranslateNpcNames && !string.IsNullOrEmpty(translatedTalkName);
        ...
        private void DrawTalkOverlay()
        {
            ...
            ImGui.PushStyleColor(ImGuiCol.Text, Service.configuration.OverlayTalkTextColor);

            ImGui.Begin(talkWindowTitle, talkWindowFlags);
            ImGui.SetWindowFontScale(Service.configuration.FontScale * Service.configuration.ImGuiTalkFontMult);
        ...
        public void UpdateBattleTalkOverlay(string originalName, string originalText, string translatedName, string translatedText)
        {
            ...
            bool showTitle = Service.configuration.BATTLETALK_TranslateNpcNames && !string.IsNullOrEmpty(translatedBattleTalkName);
        ...
        private void DrawBattleTalkOverlay()
        {
            ...
            ImGui.PushStyleColor(ImGuiCol.Text, Service.configuration.OverlayBattleTalkTextColor);

            ImGui.Begin(battleTalkWindowTitle, battleTalkWindowFlags);
            ImGui.SetWindowFontScale(Service.configuration.FontScale * Service.configuration.ImGuiBattleTalkFontMult);
        ...
        private void DrawTalkSubtitleOverlay()
        {
            ...
            ImGui.SetWindowFontScale(Service.configuration.FontScale * Service.configuration.ImGuiTalkSubtitleFontMult);
        ...
        private static void DrawToastOverlay(ToastOverlay overlay)
        {
            ...
            ImGui.SetWindowFontScale(Service.configuration.FontScale * Service.configuration.ImGuiToastFontMult);
