...
namespace Echoglossian.EFCoreSqlite.Models
{
    ...
    public class SelectString
    {
        ...
        {
            OriginalSelectString = originalSelectString;
            OriginalSelectStringLang = originalSelectStringLang;
            TranslatedSelectString = translatedSelectString;
        ...
        {
            return $"Id: {Id}, OriginalSelectString: {OriginalSelectString}, OriginalSelectStringLang: {OriginalSelectStringLang}, TranslatedSelectString: {TranslatedSelectString}, TranslationLang: {TranslationLang}, TranslationEngine: {TranslationEngine}, CreatedDate: {CreatedDate}, UpdatedDate: {UpdatedDate}";
        }
    }
}
